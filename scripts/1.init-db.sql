...
-- Supprimer le rôle 'api_osurvivors' s'il existe déjà
DROP ROLE IF EXISTS api_osurvivors;
...
-- Créer un nouvel utilisateur 'api_osurvivors' avec le mot de passe 'api_osurvivors'
CREATE USER api_osurvivors
WITH
	PASSWORD 'api_osurvivors';
